...
int main(void) {
 ...
 // 打开文件以保存合作率数据
    FILE *Sc = fopen("direct r=0.2 delta=0.01 beta=0.20 animation.csv", "w");
    ...
    for(int i = 0; i <= Round; i++){
    	if( i==0){
		    printf("shuchu bantu, i = %d\n", i);			
		    int temp_p;
			for(int j=0;j<L;j++){
				for(int z=0;z<L;z++){
					temp_p = (int)j*L+z;
					int c;
					if (strategy[temp_p] == 0 && punishment_strategy[temp_p] == 0) c=1;
	                else if (strategy[temp_p] == 0 && punishment_strategy[temp_p] == 1) c=2;
	                else if (strategy[temp_p] == 1 && punishment_strategy[temp_p] == 0) c=3;
	                else if (strategy[temp_p] == 1 && punishment_strategy[temp_p] == 1) c=4;
	    ...
	    if((0<i && i<=200&&i%2)||(200<=i&&i<=2000&&i % 20 == 0)){
		    printf("shuchu bantu, i = %d\n", i);			
		    int temp_p;
			for(int j=0;j<L;j++){
				for(int z=0;z<L;z++){
